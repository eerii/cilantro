...
def textbox_t0():
    ...
    textbox_t0.box = TextBox(ax_box, "T[0] ", initial=str(cf[0]))
...
def textbox_tn():
    ...
    textbox_tn.box = TextBox(ax_box, "T[N] ", initial=str(cf[1]))
...
def textbox_dt():
    ...
    textbox_dt.box = TextBox(ax_box, "dt ", initial=str(dt))
...
def textbox_N():
    ...
    textbox_N.box = TextBox(ax_box, "N ", initial=str(N))
...
def textbox_it():
    ...
    textbox_it.box = TextBox(ax_box, "it ", initial=str(it))
    textbox_it.box.on_submit(submit)
